...
public class StudentLinkedListTest {
	...
	private void getImplementations() {
		...
		lista1 = new RecursiveSingleLinkedListImpl<Integer>(null, new RecursiveSingleLinkedListImpl<>());
		lista2 = new RecursiveSingleLinkedListImpl<Integer>(null, new RecursiveSingleLinkedListImpl<>());
	}
